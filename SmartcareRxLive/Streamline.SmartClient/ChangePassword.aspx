        ...
        <table style="width: 213px">
            ...
            <tr>
                <td style="width: 92px" align="right">
                    <asp:Button ID="ButtonOk" runat="server" Text="OK" OnClick="ButtonOk_Click" Width="59px" CssClass="ButtonWeb"/></td>
                <td>
                    &nbsp;<asp:Button ID="ButtonCancel" runat="server" Text="Cancel" OnClick="ButtonCancel_Click" CssClass="ButtonWeb"/></td>
            </tr>
        </table>
