...
<body>
    ...
    <div>
        <table border="0" cellpadding="0" cellspacing="0" width="98%" style="padding: 2%;">
            ...
            <tr>
                <td colspan="3">
                    <textarea id="ClientAllergies_Comment" runat="server" rows="5" style="height:100%; overflow:auto; width:360px;"></textarea>                    
                </td>
            </tr>
                <tr>
                        <td colspan="3" style="padding-bottom: 8px; padding-top: 10px;">
                	    <div style="float:left;">
                	    	<label for="ClientAllergies_AllergyType_A" class="labelfor"><input runat="server" type="radio" name="ClientAllergies_AllergyType" id="ClientAllergies_AllergyType_A" value="A" />Allergy</label>
                	    	<label for="ClientAllergies_AllergyType_I" class="labelfor"><input runat="server" type="radio" name="ClientAllergies_AllergyType" id="ClientAllergies_AllergyType_I" value="I" />Intolerance</label>
                	    	<label for="ClientAllergies_AllergyType_F" class="labelfor"><input runat="server" type="radio" name="ClientAllergies_AllergyType" id="ClientAllergies_AllergyType_F" value="F" />Failed Trial</label>
                	    </div>
                            <div style="padding-right: 5px; text-align: right;">
                	    	<label for="ClientAllergies_IsActive" class="labelfor"><input runat="server" type="checkbox" name="ClientAllergies_IsActive" id="ClientAllergies_IsActive" />Active</label>
                	    </div>
                	</td>
                </tr>
            <tr>
                ...
                <td align="right">
                            <input type="button" id="ButtonSelect" style="margin-right: 10px; padding-left: 15px; padding-right: 15px;" value="Update" class="ButtonWeb" onclick=" AllergyComment.SaveComments(); " />
                    <input type="button" id="ButtonCancel" style="padding-left:15px; padding-right:15px;" value="Cancel" class="ButtonWeb" onclick="AllergyComment.closeDiv()" />
                </td>
            </tr>
        </table>        
