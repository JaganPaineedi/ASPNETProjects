                            ...
                            //if (EditableList == 'Y')
                            {
                                ...
                                if (Session["DataSetAllergy"] != null)
                                {
                                    ...
                                    if (DataRowAllergies.Length > 0)
                                    {
                                        ...
                                        GridHtml.Append("<td style='width:1%;height:5px;background-color:#fff;' valign='top'></td>");
                                }
                                else
                                {
                                    GridHtml.Append("<td style='width:1%;height:5px;background-color:#fff;' valign='top'></td>");
                                ...
                                GridHtml.Append("<td align='center' valign='top' style='width:10%'><img Height='12px' title=\"" + allergyComment.Replace("\"", "''") + "\" src='App_Themes/Includes/Images/" + allergyCommentImg.Trim() + "' ");
                                ...
                                GridHtml.Append("<td valign='top' style='width:80%' align='left'>" + ConceptDescription + " " + AllergyType + "</td>");
...
selectedMedicationId);
        ...
        public bool DeleteClientMedicationInstructions(int MedicationId, int MedicationInstructionId, string DrugStrengthRowId)
        {
            ...
            try
            {
                ...
                if (drClientMedicationInstruction.Length > 0)
                {
                    ...
                    drClientMedicationInstruction[0].AcceptChanges();
        ...
        public DataTable GenerateDiscontinueReasonDropDown()
        {
            ...
            try
            {
                ...
                dr3["PairResult"] = 3;
                dr3["PairResultData"] = "<input type='radio' id='RadioButton_Print' value='P' onclick='SelectMethodNameForSystemReport(this)'; " + (DicontinueNone == true ? "checked='checked' " : "") + "name='SelectReport'><span class='RadioDiscontinue'>Print</span></input>" +
                    (DicontinueNone == true ? "<input type='radio' id='RadioButton_None' value='N' name='SelectReport' style='display:none;'>" : "<br/><input type='radio' id='RadioButton_None' value='N' onclick='SelectMethodNameForSystemReport(this)'; checked='checked' name='SelectReport'><span class='RadioDiscontinue'>None</span></input>");
