                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <table cellpadding="0" cellspacing="0" style="border: 1px; border-color: Black; height: 100px;"
                                                id="TableAllergies">
                                                <tr>
                                                    <td style="border: 1px; border-color: Black; border-style: solid; width: 650px;">
                                                        <table cellpadding="0" cellspacing="0" style="width: 650px;">
                                                            <tr style="padding-bottom: 3px">
                                                                <td style="text-align: left; width: 650px; padding-bottom: 5px">
                                                                    <input class="parentchildbutton" type="button" id="divMultipleAccept" data-clickaction="accept"
                                                                        value="Accept" />
                                                                    <input class="parentchildbutton" type="button" id="divMultipleReject" data-clickaction="reject"
                                                                        value="Reject" />

                                                                    <div style="width: 95%; color: Black; border: solid 1px #c1cdd4; margin-left: 3%; overflow: auto; background-color: #f2f2f2;">
