    ...
    <script type="text/javascript" language="javascript">
            ...
            try {
                if (flag == true) {
                    ...
                    if (document.getElementById('<%=HiddenFieldChangePharmacyDropDownValue.ClientID %>').value == "True") {
                        ...
                        var answer = window.showModalDialog("YesNo.aspx?datetime=" + datetime.getMinutes() + datetime.getSeconds() + "&CalledFrom=PatientOverView", 'YesNo', 'menubar : no;status : no;dialogHeight:70px;dialogWidth=100px;resizable:no;dialogTop:350px;dialogLeft:300px,location:no; help: No;');
                        if (answer == undefined) {
                            } else if (answer == "N") {
                            parent.$("#DivSearch").css('display', 'none');
                            } else if (answer == "Y") {
        ...
        function openPharmacySearchForPreferredPharmacy(imgname,DropDownValue1,DropDownValue2,DropDownValue3) {
            try {
                ...
                $iFrameSearch.css({ 'width': '850px', 'height': '560px' });
                ...
                <tr>
                    <td style="text-align: center">
                        <asp:Button ID="ButtonSave" OnClick="ButtonSave_Click" runat="server" Text="Save"
                            CssClass="ButtonWeb" Width="80px" Font-Size="11px"></asp:Button>
                        <asp:Button ID="btnClose" runat="server" CssClass="ButtonWeb" OnClientClick="closeDivPharmacies(false); return false;"
