...
<head id="Head1" runat="server">
 ...
 function ValidateFirstLastName(txtLastName, txtFirstName, lblError, imgError) {
   ...
   function onsetfocus() {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <table cellpadding="0" cellspacing="0" border="0">
                                                                        ...
                                                                        <table cellpadding="0" cellspacing="0" border="0">
                                                                            <tr>
                                                                                <td valign="top" style="height: 20px; width: 83px;" align="left">
                                                                                    <asp:Button ID="btnClear" runat="server" Width="82px" CssClass="ButtonWeb" EnableViewState="False"
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table width="600px" style="background-color: #DCE5EA" cellpadding="0" cellspacing="0">
                                                                            <tr>
                                                                                <td>&nbsp;
                                                                                </td>
                                                                            </tr>
                                                                                    ...
                                                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td align="left" valign="top" style="height: 24px">
                                                                                                <asp:Button ID="btnBroadSearch" runat="server" Width="96px" CssClass="ButtonWeb"
                                                                                            ...
                                                                                            <td align="left" valign="top" style="height: 24px">
                                                                                                <asp:Button ID="btnNarrowSearch" runat="server" Width="96px" CssClass="ButtonWeb"
                                                                                                    EnableViewState="False" Text="Narrow Search" OnClick="btnNarrowSearch_Click"
                                                                                                    OnClientClick="fnShowParda(350,55);" TabIndex="3"></asp:Button>
                                                                                            </td>
                                                                                    ...
                                                                                    <table>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td align="left" valign="top">
                                                                                                <asp:Label ID="labelText" runat="server" BackColor="#DCE5EA" Font-Bold="True" Font-Names="Arial"
                                                                                                    Font-Size="8.5pt" ForeColor="#14426B" Height="11px" Width="65px">Last Name</asp:Label>
                                                                                            </td>
                                                                                            <td></td>
                                                                                            <td>
                                                                                            ...
                                                                                            <td></td>
                                                                                            <td valign="middle">
                                                                                                <asp:Label ID="lblFirstName" runat="server" BackColor="#DCE5EA" Font-Bold="True"
                                                                                                    Font-Names="Arial" Font-Size="8.5pt" ForeColor="#14426B" Height="11px" Width="65px">First Name</asp:Label>
                                                                                            </td>
                                                                ...
                                                                <tr style="width: 600px">
                                                                    <td>
                                                                        <table style="background-color: #DCE5EA" width="600px" border="0" cellpadding="0"
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="left" style="height: 24px">
                                                                                    <asp:Button ID="btnSSNSearch" runat="server" Width="128px" CssClass="ButtonWeb" EnableViewState="False"
                                                                                ...
                                                                                <td style="height: 24px">
                                                                                    <asp:Button ID="btnPhoneSearch" runat="server" Width="112px" CssClass="ButtonWeb"
                                                                                        EnableViewState="False" Text="Phone # Search" Height="23px" OnClick="btnPhoneSearch_Click"
                                                                                        OnClientClick="fnShowParda(350,55);" TabIndex="10"></asp:Button>
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                <td style="height: 5px; width: 3px;"></td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td style="height: 21px">
                                                                                    <asp:Button ID="btnDOBSearch" runat="server" Width="128px" CssClass="ButtonWeb" EnableViewState="False"
                                                                                ...
                                                                                <td style="height: 21px; width: 157px;">
                                                                                    ...
                                                                                    <img src="App_Themes/Includes/Images/calender_Blue.jpg" onmouseover="CalShow( this, '<%=txtDOBSearch.ClientID %>')"
                                                                                        alt="" id="imgEnteredTo" />
                                                                                </td>
                                                                                <td style="height: 21px"></td>
                                                                                <td style="height: 21px">
                                                                                    <asp:Button ID="btnClientIdSearch" runat="server" Width="112px" CssClass="ButtonWeb"
                                                                                        EnableViewState="False" Text="Patient ID Search" OnClick="btnClientIdSearch_Click"
                                                                                        Visible="true" OnClientClick="fnShowParda(350,55);" TabIndex="16"></asp:Button>
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                <td style="height: 10px; width: 3px;"></td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table cellpadding="0" cellspacing="0" border="0">
                                                                            <tr>
                                                                                <td valign="top">
                                                                                    <asp:Button ID="btnSelect" runat="server" Width="82px" CssClass="ButtonWeb" EnableViewState="False"
                                                                                        OnClientClick="fnShowParda(350,55);" Text="Select" OnClick="btnSelect_Click"></asp:Button><asp:Button ID="btnCancel" runat="server" Width="82px" Height="21px"
                                                                                            CssClass="ButtonWeb" EnableViewState="False" Text="Cancel" Font-Names="Microsoft Sans Serif"
                                                                                            Font-Size="8.25pt" Visible="False" OnClientClick="closeDiv();"></asp:Button>
                                                                                </td>
                                                                                <td valign="top" style="width: 2%;"></td>
                                                                                <td valign="top" style="width: 71px;">
                                                                                    <input id="btn1" type="button" value="Cancel" onclick="closeDiv();" class="ButtonWeb"
                                                                                           style="font-size: 8.25pt; height: 24px; width: 82px;" />
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
    ...
    <script type="text/jscript">        parent.fnHideParentDiv();</script>
