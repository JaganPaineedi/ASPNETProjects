            ...
            <td style="width: 100%;">
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                    ...
                    <tr>
                        <td align="right">
                            &nbsp;&nbsp;
                            <asp:Button ID="ButtonPrescribe" CssClass="ButtonWeb" runat="server" Font-Size="11px"
                                Text="Print" Width="100px" OnClientClick="ShowDivForConsentPrint();return;" />&nbsp;
                            <asp:Button ID="ButtonClose" CssClass="ButtonWeb" runat="server" Font-Size="11px"
                                Text="Close" Width="65px" OnClientClick="redirectToViewConsentHistoryPageClearSession(); return false;" />
                            <asp:Button ID="ButtonClose1" CssClass="ButtonWeb" runat="server" Font-Size="11px"
