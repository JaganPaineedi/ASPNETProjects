...
<table>
    <tr>
        ...
        <td style="width: 50%;">
            ...
            <asp:Button ID="ButtonMedAdd" Text="Add Med Reconciliation" Style="text-align: center" Width="145px" Height="20px" runat="server" OnClientClick="FillMedReconciliationDataListControl(this);return false;" />
