...
<table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td style="width: 140px">
                        <input id="ButtonEdit" type="button" value="Preferred Pharmacy" onclick="return ShowPreferredPharmaciesDiv();"
                            class="ButtonWebBold" <%=enableDisabled(Streamline.BaseLayer.Permissions.EditPreferredPharmacy)%> />
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        <td id="tdHealthData" height="100%" valign="top" rowspan="2" style="border-top: #dee7ef 3px solid; border-right: #dee7ef 3px solid; border-left: #dee7ef 3px solid; border-bottom: #dee7ef 3px solid;">
            <div style="height: 22px; width: 100%;">
                <ul class="tabs" style="height: 100%;">
                    <li style="left: 0px; top: 0px"><a href="#tab1">Patient Overview</a></li>
                    <li style="display: none;"><a href="#tab2">Health Data</a></li>
                    <li style="display: none;"><a href="#tab3">Graph</a></li>
                    <li style="left: 0px; top: 0px" <%= enableDisabled(Streamline.BaseLayer.Permissions.Reconciliation) == "Disabled" ? "style='display:none;'" : "" %>><a href="#tab4">Reconciliation</a></li>
                    ...
                    <li style="left: 0px; top: 0px" <%= enableDisabled(Streamline.BaseLayer.Permissions.Eligibility) == "Disabled" ? "style='display:none;'" : "" %>><a href="#tab6">Eligibility</a></li>
                    <li style="left: 0px; top: 0px" <%= enableDisabled(Streamline.BaseLayer.Permissions.MedicationHistory) == "Disabled" ? "style='display:none;'" : "" %>><a href="#tab7">Medication History</a></li>
                </ul>
            </div>
            ...
            <table id="TableKnownallergies" width="100%" runat="server">
                ...
                <tr>
                    <td valign="top" id="TDInactiveAllergyButton">
                        <span style="margin-right: 5px; margin-left: 5px;" class="ButtonWeb">Show:</span>
                        <input type="radio" id="ClientAllergiesInactiveActiveRButton_All" name="ClientAllergiesInactiveActiveRButton"
                            onclick="ShowInactiveActiveButtonClickCall(this);" /><span class="ButtonWeb" style="margin-right: 5px;">All</span>
                        <input type="radio" checked="checked" id="ClientAllergiesInactiveActiveRButton_Active"
                            name="ClientAllergiesInactiveActiveRButton" onclick="ShowInactiveActiveButtonClickCall(this);" /><span
                                class="ButtonWeb">Active Only</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr style="height: 10%">
                    ...
                    <td valign="bottom">
                        <input type="button" id="LinkButtonAddAllergy" style="visibility: hidden" name="LinkButtonAddAllergy"
                            onclick="return ShowAllergySearchPage(); return false;" value="Add Allergy" class="ButtonWebBold"
