...
<div id="DivPharmacyList" style="width: 100%; overflow: none; height: 250px;">
    <asp:Panel ID="PanelPharmaciesListSearchPage" runat="server">
        <asp:GridView ID="GridViewSearchPharmacies" runat="server" AllowSorting="True" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    <HeaderTemplate>
                        <asp:Label ID="LabelHeaderActive" Text="A" runat="server" Style="cursor: pointer;
                            text-decoration: underline"></asp:Label>
                    </HeaderTemplate>
                    <ItemTemplate>
                ...
                <asp:TemplateField>
                    <HeaderTemplate>
                        <asp:Label ID="LabelHeaderSpecialty" Text="Specialty" runat="server" Style="cursor: pointer; text-decoration: underline"></asp:Label>
                    </HeaderTemplate>
                    <ItemTemplate>
