...
<div>
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td style="width: 30%" align="right">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                     <td align="right" style="width: 28%;display:none"  onclick="ShowKeyPhrasePage();return false;" >
                                         <a href="#">Add Key Phrases</a> 
                                     </td>
                                     <td align="right" id="KeyPhrases" runat="server" style="width: 24%" >
                                        <a href="#" id="aTag" runat="server" onclick="ShowUseKeyPhrasePage();return false;"><img src="App_Themes/Includes/Images/key.png" title="Key Phrases" /></a>
                                     </td>
        ...
        <tr>
            <td style="border-bottom: #5b0000 1px solid; height: 1pt; width: 872px;"></td>
        </tr>
        <tr>
            <td>
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td align="right">
                            <asp:Button ID="ButtonDeleteCurrentMedications" CssClass="ButtonWebBold" runat="server"
                                Text="Delete" OnClick="ButtonDeleteCurrentMedications_Click"
                                Visible="false" />
                            <asp:Button ID="ButtonUpdate" CssClass="ButtonWeb" runat="server" Font-Size="11px"
                                Text="Update" Width="71px" OnClick="ButtonUpdate_Click" Visible="false" />&nbsp;
                            <asp:Button ID="ButtonPrescribe" CssClass="ButtonWebBold" runat="server"
                                Text="Prescribe" OnClientClick=" return InsertBeforePrescribe(); "
                                OnClick="ButtonPrescribe_Click" />&nbsp;
                            <asp:Button runat="server" ID="ButtonQueueOrder" Text="Queue Order"
                                CssClass="ButtonWebBold" OnClientClick=" return InsertBeforePrescribe(); " OnClick="ButtonQueueOrder_Click" />&nbsp;
                            <asp:Button ID="ButtonClose" CssClass="ButtonWebBold" runat="server"
                                Text="Cancel" OnClientClick=" ClientMedicationOrder.CloseButtonClick(); return false; " />
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td style="width: 100%;">
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                                            ...
                                                            <td align="left" style="width: 100px; padding-left: 10px" nowrap="nowrap">
                                                                <asp:Panel ID="PanelDropDownListPharmacies" runat="server">
                                                                    ...
                                                                    <cc2:StreamlineDropDowns ID="DropDownListPharmacies" Width="350px" 
                                                                        ...
                                                                        EnableViewState="false" DropDownStyle="DropDown" AddBlankRow="true"
                                        ...
                                        <table border="0" cellspacing="1" cellpadding="1">
                                            <tr>
                                                ...
                                                <td nowrap="nowrap" valign="middle">
                                                    ...
                                                    <img id="Img2" src="App_Themes/Includes/Images/calender_White.jpg" onclick="ClientMedicationOrder.CalShow( this, '<%=TextBoxOrderDate.ClientID%>')"
                                                ...
                                                <td class="labelFont" colspan="1" nowrap="nowrap" style="width: 100px;" valign="middle">Verbal Order Read Back
                                                </td>
                                    ...
                                    <td>
                                        <table border="0" cellspacing="1" cellpadding="1">
                                            <tr>
                                                ...
                                                <td colspan="2" nowrap="nowrap" valign="middle" style="width: 200px;">
                                                    ...
                                                    <div id="ComboBoxDrugDDDiv" style="border: solid 1px #7b9ebd;" onclick=" ClientMedicationOrder.onClickDrugComboList(this, '#ComboBoxDrugDDList');">
                                                        <input type="text" id="ComboBoxDrugDD" value="" opid="" style="border: none; width: 160px;"
                                                ...
                                                <td style="width: 20px;" valign="middle">
                                                    <img id="ImgSearchIcon" src="App_Themes/Includes/Images/search_icon.gif" style="cursor: pointer; display: none; visibility: hidden;"
                                                        ...
                                                        align="middle" title="View Report" />
                                                    <img id="ImgComments" src="App_Themes/Includes/Images/comment.png" style="display: none;"
                                                        align="middle" />
                                                </td>
                                                <td class="labelFont" colspan="1" nowrap="nowrap" style="width: 100px;" valign="middle">Dispense as Written
                                                </td>
                                                <td colspan="1" nowrap="nowrap" style="width: 20px;" valign="middle">
                                                ...
                                                <td style="width: 61px;" class="labelFont">Active Coverage
                                                </td>
                                                <td style="width: 103px;" valign="middle">
                                        ...
                                        <table border="0" cellpadding="1" cellspacing="1">
                                            <tr>
                                                <!--<td class="labelFont" style="width: 50px;">
                                                    Special Instructions
                                                </td>!-->
                                                <td class="labelFont" style="width: 53px;">
                                                ...
                                                <td style="height: 24px">
                                                    <asp:TextBox ID="TextBoxSpecialInstructions" EnableTheming="false" runat="server" onclick="ClientMedicationOrder.ResetDrugComboList('#ComboBoxDrugDDList');"
                                                        TextMode="MultiLine" MaxLength="90" Width="180px" CssClass="TextboxMultiline"></asp:TextBox>
                                                </td>
                                                <td style="height: 24px; width: 18px;"></td>
                                                <td class="labelFont" style="width: 62px;">Desired Outcome
                                                </td>
                                                ...
                                                <td class="labelFont" style="width: 101px;">
                                                ...
                                                <td class="labelFont" colspan="1" style="width: 65px" nowrap="nowrap">Include On Prescription
                                                </td>
                                                <td colspan="1">
                                                    <input id="CheckboxIncludeOnPrescription" type="checkbox" runat="server" title="" onclick="ClientMedicationOrder.ResetDrugComboList('#ComboBoxDrugDDList');" />
                                                </td>
                                                <td align="right">
                    ...
                    <tr>
                        <td style="width: 6%;">
                            <input type="button" id="ButtonTitrate" class="ButtonWeb" onclick=" OpenTitratePage()"
                        ...
                        <td colspan="23" style="height: 126px">
                            <div style="height: 120px; overflow: auto;">
                                <table border="0" width="98%">
                                    ...
                                    <tr>
                                        <td>
                                            <input type="button" id="buttonAddRows" class="ButtonWeb" onclick="AddSteps()" value="More Steps"
                                                disabled="disabled" tabindex="0" />
                                        </td>
                                        <td align="right">
                                            <input type="button" id="buttonInsert" class="ButtonWeb" onclick="Insert_Click()"
                                                value="Insert" tabindex="0" />
                ...
                <table style="width: 100%;" id="HeadingMedicationListSection">
                    <tbody>
                        <tr>
                            <td style="width: 100%;" valign="top">
                                <UI:Heading ID="HeadingMedicationList" runat="server" HeadingDetailId="MedicationListDetailTabs"></UI:Heading>
                                <div id="Div1" style="height: 250px; overflow:initial">
                                <table style="border: #dee7ef 3px solid;" cellspacing="0" cellpadding="0" id="MedicationListContainer" width="100%">
                                    <tbody>
                                        <tr id="MedicationOrderMedicationList" class="HeaderTabContent">
                                            <td style="width: 100%;">
                                                <div id="MedicationListInformation" style="height: 250px; overflow: auto">
                                                    <asp:Panel ID="PanelMedicationListInformation" runat="server" Height="250px" Width="100%" BackColor="White"
                                                                ...
                                                                <table cellpadding="3" cellspacing="0" border="0" width="100%">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="padding-right: 13px">
                                                                            <input type="button" class="ButtonWeb" id="buttonok" runat="server" value="OK"
                                                                                onclick="ClientMedicationOrder.SelectDaysOfWeekClick()" />
                                                                        </td>
                                                                        <td>
                                                                            <input type="button" class="ButtonWeb" id="Button1" value="Cancel" tabindex="2"
        ...
        <tr>
            <td style="width: 872px">
                ...
                <img id="ImgStartDate" src="App_Themes/Includes/Images/calender_White.jpg" style="display: none"
                ...
                <asp:HiddenField ID="HiddenFieldPharmacyId" runat="server" />
                 <asp:HiddenField ID="HiddenFieldOrderType" runat="server" /> <%--Added By Pranay w.r.t MeaningFull use--%>

            </td>
        </tr>
    </table>
</div>
<asp:Button CssClass="ButtonWeb" ID="ButtonSuggestedProtocol" Enabled="false" runat="server"
