...
public partial class UserControls_PrinterList : Streamline.BaseLayer.BaseActivityPage
{
    ...
    public void GenerateRows(DataTable _dtPrinter)
    {
        try
        {
            ...
            thBlank1.Width = new Unit(2, UnitType.Percentage);
            TableHeaderCell thBlank2 = new TableHeaderCell();
            thBlank2.Width = new Unit(3, UnitType.Percentage);
            ...
            thID.Width = new Unit(5, UnitType.Percentage);
            ...
            thActive.Width = new Unit(5, UnitType.Percentage);
            ...
            thDeviceUNCPath.Width = new Unit(50, UnitType.Percentage);
            ...
            if (_dtPrinter.Rows.Count > 0)
            {
                foreach (DataRow dr in _dtPrinter.Rows)
                {
                    ...
                    tbPrinterList.Rows.Add(GenerateSubRows(dr, PrinterDeviceLocationId, DeviceLabel, active, DeviceUNCPath, tbPrinterList.ClientID, ref myscript));
                }
            }
    ...
    private TableRow GenerateSubRows(DataRow dr, Int32 PrinterDeviceLocationId, string DeviceLabel, string active, string DeviceUNCPath, string tableId, ref string myscript)
    {
        try
        {
            CommonFunctions.Event_Trap(this);
