...
<asp:Panel ID="PanelOutBoundPrescription" Style="height: 500px;" runat="server" Width="98%">
                                ...
                                <asp:ListView runat="server" ID="lvOutBoundPrescriptionList" OnLayoutCreated="LayoutCreated">
                                    <LayoutTemplate>
                                        <table cellpadding="0" cellspacing="0" class="ListPageContainer">
                                            <tr>
                                                <td>
                                                    <asp:Panel runat="server" ID="divHeader" Style="width: 832px; margin-right: 18px;" CssClass="ListPageHeader">
                                                        <table cellpadding="0" cellspacing="0" width="1182px" id="OutBoundPrescriptionHeader">
                                                            <tr>
                                                                <td width="10%">
                                            ...
                                            <tr>
                                                <td valign="top">
                                                    <asp:Panel ID="divListPageContent" runat="server" Style="width: 850px; height: 500px;"
                                                        CssClass="ListPageContent">
                                                        <table width="1182px" cellspacing="0" cellpadding="0" id="OutBoundPrescriptionList">
