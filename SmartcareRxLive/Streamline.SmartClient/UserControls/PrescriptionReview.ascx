            ...
            <table width="100%" border="0">
                <tr>
                    ...
                    <td>
                        ...
                        <asp:Button ID="ButtonApprove" runat="server" Text="Approve" OnClientClick="return Validate();" CssClass="ButtonWeb" OnClick="ButtonApprove_Click" /></td>
                    <td>
                        <input type="button" id="ButtonClose" value="Close" class="ButtonWeb" width="79px"
