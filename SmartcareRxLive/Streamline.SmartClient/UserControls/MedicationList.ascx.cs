    ...
    public partial class UserControls_MedicationList : BaseActivityPage
    {
        ...
        private void GenerateRows()
        {
            ...
            try
            {
                ...
                thcInstructions.Style.Add("width", "20%");
                //Added bt Loveena on 05-Jan-2009
                if (_dtMedicationTemp.Rows.Count > 0)
                                ...
                                String[] columnNames =
                            {
                                ...
                                foreach (DataRow drTemp in drMedInstructions)
                                {
                                    ...
                                    tblMedication.Rows.Add(GenerateSubRows(drTemp, prescribedBy, tblMedication.ClientID,
                                                                           ...
                                                                           SureScriptsOutgoingMessageId, PharmacyName, SmartCareOrderEntry, COMPLETEORDERSTORX, AddedBy, DiscontinuedBy));//
        ...
        private TableRow GenerateSubRows(DataRow drTemp, string PrescribedBy, string tableId, ref string myscript,
                                         ...
                                         int MedicationNameId, string SureScriptsOutgoingMessageId, string PharmacyName, string SmartCareOrderEntry, string COMPLETEORDERSTORX, string AddedBy, string DiscontinuedBy)
        {
            try
            {
                CommonFunctions.Event_Trap(this);
                ...
                btnAckTemp.Attributes.Add("class", "ButtonWeb");
                ...
                //start
                    ...
                    else
                    {
                        ...
                        else { trTemp.CssClass = "GridViewRowStyle"; }
                    }
        ...
        private TableRow GenerateSubTitrationRows(DataRow drTemp, string tableId, ref string myscript,
                                                  bool dateWarningFlag, string warningMessage)
