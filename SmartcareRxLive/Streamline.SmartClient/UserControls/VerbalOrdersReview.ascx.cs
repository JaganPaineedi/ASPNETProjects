...
public partial class UserControls_VerbalOrdersReview : BaseActivityPage
{
    ...
    public void createControls()
    {
        ...
        try
        {
            ...
            {
                                              tableControls.Rows.Add(CreateOrderRow(_dsVerbalOrder.Tables[0].Rows[_RowCount], _RowCount, ref myscript));
                               }
            myscript += "}</script>";
    ...
    private TableRow CreateOrderRow(DataRow dr, int rowIndex, ref string myscript)
    {
        try
        {
