...
<div>
            ...
            <td style="height: 25px" align="left">
                <table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td colspan="1" nowrap="nowrap">
                            <input type="button" id="ButtonConsentEdit" value="Edit" class="ButtonWebBold" onclick="javascript:ChangeConsentFormMode(this);" />
                        </td>
                        <!--Ended over here-->
                        <td width="15px">
                        </td>
                        <td colspan="1" nowrap="nowrap">
                            <input type="button" id="ButtonPrint" value="Print" class="ButtonWebBold" 
    ...
    <table id="Table1" runat="server" cellpadding="0" cellspacing="0" style="border-right: #dee7ef 3px solid;
        ...
        width: 99%; height: 200px; overflow: scroll">
        <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td style="height: 25px">
                            <input type="button" id="ButtonSign" class="ButtonWebBold" onclick="OpensignaturePad();return false;"
                                value="Sign" runat="server" />
                        </td>
                        <td style="width: 10px">
                        </td>
                        <td style="height: 25px">
                            <input type="button" id="ButtonCancel" class="ButtonWebBold" onclick="redirectToPage();return false;"
                                value="Close" />
                        </td>
