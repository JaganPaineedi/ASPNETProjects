...
<div>
    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="height: 470px">
        <tr>
            <td style="width: 100%">
                        ...
                        <td style="width: 30%" align="right">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td align="right" style="width: 24%" id="KeyPhrases" runat="server" >
        ...
        <tr>
            <td style="border-bottom: #5b0000 1px solid; height: 1pt;" colspan="3"></td>
        </tr>
        <tr>
            <td align="right">
                <asp:Button ID="ButtonUpdate" CssClass="ButtonWebBold" runat="server"
                    Text="Update" OnClick="ButtonUpdate_Click" />&nbsp;
                <asp:Button ID="ButtonCancel" CssClass="ButtonWebBold" runat="server"
                    Text="Close" OnClientClick=" ClientMedicationNonOrder.CloseButtonClick(); return false; " />
            </td>
        </tr>
        <tr>
            <td>
                                        ...
                                        <table border="0" cellspacing="1" cellpadding="1">
                                            <tr>
                                                ...
                                                <td colspan="2" nowrap>
                                                    ...
                                                    <img id="Img1" src="App_Themes/Includes/Images/calender_White.jpg" onclick=" CalShow(this, '<%= TextBoxStartDate.ClientID %>') "
                                    ...
                                    <td>
                                        ...
                                        <table border="0" cellpadding="1" cellspacing="1">
                                            <tr>
                                                ...
                                                <td class="labelFont" colspan="1" style="height: 24px; width: 110px;" nowrap="nowrap">Include On Prescription
                                                </td>
                    ...
                    <tr>
                        <td colspan="2">
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="width: 2px" valign="bottom"></td>
                                    <td valign="top">
                                        <asp:Image ID="ImageGridError" runat="server" ImageUrl="~/App_Themes/Includes/Images/error.gif"
                                            Style="display: none" />
                                    </td>
                                    <td valign="top">&nbsp;
                                        <asp:Label ID="LabelGridErrorMessage" runat="server" CssClass="redTextError" BackColor="#DCE5EA"
                                            Height="20px" Style="vertical-align: middle"></asp:Label>
                                    </td>
                                    <td valign="top">
        ...
        <tr>
            <td style="height: 5px; width: 889px;">
