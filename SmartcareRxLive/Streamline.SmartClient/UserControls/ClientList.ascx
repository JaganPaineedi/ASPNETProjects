        ...
        <tr>
            ...
            <td align="right" style="width: 30%">
                <asp:LinkButton ID="LinkButtonLogout" Text="Logout" runat="server" OnClick="LinkButtonLogout_Click"
                    TabIndex="5" Style="display: none;"></asp:LinkButton>
            </td>
        </tr>
        <tr>
    ...
    <table id="StartPage" width="98%" border="0" cellpadding="0" cellspacing="0" runat="server">
        <tr>
            <td width="950px" align="left">
                <asp:Button ID="ButtonMyPreferences" runat="server" CssClass="ButtonWebBold" TabIndex="6" Text="My Preferences"
                    OnClientClick="redirectToUserPreferencesPage('ClientList');this.disabled=true;return false;" OnClick="ButtonMyPreferences_Click" />
                <asp:Button ID="ButtonPatientSearch" runat="server" CssClass="ButtonWebBold" TabIndex="7" Text="Patient Search"
                    OnClick="ButtonPatientSearch_Click" />
                <asp:Button ID="ButtonManageUsers" CssClass="ButtonWebBold" runat="server" TabIndex="8" Text="Manage Users"
                    OnClientClick="redirectToUserManagementPage();this.disabled=true;return false;" />
                <asp:Button ID="ButtonManagePharmacies" CssClass="ButtonWebBold" runat="server" TabIndex="9"
                    Text="Manage Pharmacies" OnClientClick="redirectToPharmacyManagementPage();this.disabled=true;return false;" />
                <asp:Button ID="ButtonPrinter" CssClass="ButtonWebBold" runat="server" TabIndex="10" Width="185px" Text="Printer Device Locations"
                    OnClientClick="redirectToPrinterDeviceLocationPage();this.disabled=true;return false;" />
                <asp:Button ID="ButtonRefreshSharedTables" runat="server" TabIndex="11" CssClass="ButtonWebBold" Text="Refresh Shared Tables" OnClientClick="RefreshSharedTablesStartPage();return false;" />
                <asp:Button ID="ButtonReviewPrescriptions" runat="server" Text="Pending Review" CssClass="ButtonWebBold" TabIndex="12" OnClientClick="redirectToReviewPrescriptions();this.disabled=true;return false;" />
                <asp:Button ID="ButtonVerbalOrders" runat="server" CssClass="ButtonWebBold" Text="Verbal Orders" OnClientClick="redirectToVerbalOrder('V');this.disabled=true;return false;" TabIndex="13" />
                <asp:Button ID="ButtonQueuedOrders" runat="server" CssClass="ButtonWebBold" Text="Queued Orders" OnClientClick="redirectToVerbalOrder('A');this.disabled=true;return false;" TabIndex="14" />
                <asp:HiddenField ID="HiddenFieldVerbalOrderType" runat="server" />
            </td>
        </tr>
    </table>
    <table id="TableDashboard" runat="server" cellpadding="0" cellspacing="0" border="0"
        width="100%">
        <tr>
            <td>&nbsp;
            </td>
        ...
        <tr>
            <td id="tdDashboard" valign="top" rowspan="2" style="height: 350px;">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <asp:Panel ID="PanelRefillRequest" runat="server" ScrollBars="Vertical" Height="320px" Width="100%" Style="overflow-x: none; overflow-y: auto;">
    ...
    <tr>
        ...
        <td align="left">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<asp:Button ID="ButtonSubmit" Text="Submit"
                runat="server" CssClass="ButtonWeb" OnClick="ButtonSubmit_Click" TabIndex="3" />
            <asp:Button runat="server" ID="ButtonCancel" Text="Cancel" CausesValidation="False"
                CssClass="ButtonWeb" OnClick="ButtonCancel_Click" TabIndex="4"></asp:Button>
        </td>
    </tr>
</table>
