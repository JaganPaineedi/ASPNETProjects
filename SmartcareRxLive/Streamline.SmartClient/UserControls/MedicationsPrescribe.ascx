                ...
                <tr>
                    <td>
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td align="left" style="height: 30px; width: 3%" valign="top">
                    ...
                    <td>
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td align="right" nowrap="nowrap">
                                    <asp:Button runat="server" ID="ButtonDeleteMedications" Font-Size="11px" Height="25px"
                                        Width="5px" CssClass="ButtonWeb" Visible="false" OnClick="ButtonDeleteMedications_Click" /><asp:Button
                                            ID="ButtonPatientContent" runat="server" Font-Size="11px" Height="25px" Text="Patient Consent"
                                            CssClass="ButtonWeb" OnClientClick="javascript:redirectToPatientContentPage();return false;"
                                    ...
                                    <asp:Button runat="server" ID="ButtonQueueOrder" Font-Size="11px" Height="25px" Text="Queue Order"
                                        Width="70px" OnClick="ButtonQueueOrder_Click" CssClass="ButtonWeb" Visible="false" />
                                    <asp:Button runat="server" ID="ButtonChangeOrder" Text="Change Order" Font-Size="11px"
                                        Height="25px" Width="88px" OnClientClick="MedicationPrescribe.onChangeOrderClick();" CssClass="ButtonWeb" />
                                    <asp:Button
                                            ID="ButtonPharmacyPreview" runat="server" Font-Size="11px" Height="25px" Text="Pharmacy Preview"
                                            CssClass="ButtonWeb" OnClientClick="javascript:redirectToPharmacyPreview();return false;"
                                    ...
                                    <asp:Button runat="server" ID="ButtonNewOrder" Font-Size="11px" Height="25px" Text="Prescribe"
                                        Width="100px" OnClick="ButtonNewOrder_Click" CssClass="ButtonWeb" OnClientClick="this.disabled = true;parent.window.updatePageCalledFrom('MedicationPrescribe');MedicationPrescribe.ControlledSubstancesList();" UseSubmitBehavior="false" />
                                    <asp:Button ID="ButtonCancel" runat="server" Font-Size="11px" Height="25px" Text="Cancel"
                                        OnClientClick="MedicationPrescribe.CloseButtonClick1();return false;" Width="70px" CssClass="ButtonWeb" />
                                </td>
                            </tr>
                        </table>
                    </td>
