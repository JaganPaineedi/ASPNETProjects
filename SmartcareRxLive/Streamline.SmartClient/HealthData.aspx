                                                ...
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%" >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="">
                                                            ...
                                                            <img id="Img1" src="App_Themes/Includes/Images/calender_White.jpg" onclick="CalShow( this, '<%=TextBoxDate.ClientID%>')"
                                                    ...
                                                    <tr>
                                                        <td align="center" colspan="2">
                                                            <input type="button" id="ButtonSave" value="Save" tabindex="8" class="ButtonWeb" runat="server" style="height: 23px; width: 55px" />
                                                            <asp:Button ID="btnCancel" runat="server" TabIndex="9" CssClass="ButtonWeb" OnClientClick="closeHealthPage('btnCancel');return false;"
                                                                Text="Cancel" />
                                                        </td>
                                                    </tr>
                                                </table>
