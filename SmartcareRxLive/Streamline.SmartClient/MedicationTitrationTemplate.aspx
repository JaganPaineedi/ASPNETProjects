        ...
        <table border="0" cellpadding="0" cellspacing="0">
            ...
            <tr >
                <td colspan="3" align="center" valign="bottom">
                    <input type="button" id="ButtonSave" class="ButtonWeb" value="Save" style="width: 70px;"
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <input type="button" id="ButtonCancel" class="ButtonWeb" value="Cancel" style="width: 70px;"
