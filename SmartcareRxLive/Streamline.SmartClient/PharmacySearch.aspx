...
<body>
    ...
    <div>
        ...
        <table>
            ...
            <tr>
                <td>
                            <table style="border-bottom: #dee7ef 3px solid; border-left: #dee7ef 3px solid; border-right: #dee7ef 3px solid; border-top: #dee7ef 3px solid; width: 99%;" cellspacing="0" cellpadding="0">
                        <tr>
                            <td>
                                <table border="0" cellpadding="1" cellspacing="1" width="100%">
                                    <tr>
                                        ...
                                        <td class="labelFont" valign="middle" style="width: 22px">
                                        ...
                                        <td nowrap="nowrap" valign="middle" style="width: 100px;">
                                    ...
                                    <tr>
                                        <td class="labelFont" nowrap="nowrap" style="width: 135px;" valign="middle">
                                            <asp:Label ID="labelAddress" runat="server" Text="Address" CssClass="Label" />
                                        </td>
                                        <td nowrap="nowrap" valign="middle" style="width: 179px;">
                                            <asp:TextBox ID="TextBoxAddress" runat="server" Width="200px" MaxLength="100"></asp:TextBox>
                                        </td>
                                        <td style="width: 2px">
                                        </td>
                                        <td class="labelFont" nowrap="nowrap" valign="middle" style="width: 42px;">
                                        ...
                                        <td class="labelFont" nowrap="nowrap" style="width: 80px;" valign="middle">
                                    ...
                                    <tr>
                                        <td class="labelFont" nowrap="nowrap" valign="middle" style="width: 135px;">
                                        ...
                                        <td class="labelFont" nowrap="nowrap" style="width: 42px;">
                                            <asp:Label ID="lableFax" runat="server" Text="Fax #" CssClass="Label" />
                                        </td>
                                        <td nowrap="nowrap" valign="middle" style="width: 80px;">
                                            <asp:TextBox ID="TextBoxFax" runat="server" Width="162px" MaxLength="50"></asp:TextBox>
                                        </td>
                                        <td style="width: 2px">
                                        </td>
                                        <td class="labelFont" nowrap="nowrap" valign="middle" style="width: 80px;">
                                    ...
                                    <tr>
                                        ...
                                        <td nowrap="nowrap" valign="middle" style="width: 223px;" colspan="3">
        ...
        <table>
            <tr>
                ...
                <td align="right" style="width: 10%">
                    <input type="button" id="buttonSearch" class="ButtonWeb" onclick="FillPharmacyList();"
                        value="Search" tabindex="0" runat="server" />
                </td>
                <td align="right" style="width: 5%">
                    <input type="button" id="buttonClear" class="ButtonWeb" value="Clear" tabindex="1"
                        onclick="ClearFields();" />
                </td>
                <td>
                </td>
        ...
        <table>
            <tr>
                ...
                <table width="100%" style="border-bottom: #dee7ef 3px solid; border-left: #dee7ef 3px solid; border-right: #dee7ef 3px solid; border-top: #dee7ef 3px solid; height: 200px; width: 100%;" cellspacing="0" cellpadding="0">
            <tr>
                <td colspan="2">
            ...
            <tr>
                <td align="right" style="width: 50%">
                    <asp:Button ID="ButtonSelect" runat="server" Text="Select" OnClientClick="Select_Click(); return false;"
                        disabled="disabled" CssClass="ButtonWeb" />
                </td>
