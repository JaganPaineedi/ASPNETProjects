                                            ...
                                            <td colspan="3" align="center">
                                                    ...
                                                    <tr>
                                                        <td valign="top" align="center" style="height: 20px; width: 71px;">
                                                            <input id="btnSelect" type="button" value="Select" class="ButtonWeb" onclick="return ClientMedicationDrugs.fnReturnValues('#DivGridViewDrug');" /></td>
                                                        <td valign="top" style="height: 20px; width: 2%;"></td>
                                                        <td valign="top" style="height: 20px; width: 71px;">
                                                            <input type="button" class="ButtonWeb" id="btnClose" value="Close" onclick="ClientMedicationDrugs.closeDiv();" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
