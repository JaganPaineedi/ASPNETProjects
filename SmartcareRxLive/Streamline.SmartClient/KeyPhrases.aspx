                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            ...
                                            <td align="right" nowrap="nowrap">
                                                <input type="Button" class="ButtonWebBold" id="ButtonEditAgencyPhrases" value="Edit Agency Phrases" onclick="OpenEditAgencyPhrases();" />
                                                <input type="button" value="Save/Close" style="width: 100px" class="ButtonWebBold" onclick="SaveKeyPhrases();" />                          
                                                <input type="button" ID="btnClose" runat="server" class="ButtonWebBold" onclick="ClientMedicationOrder.CloseKeyPhrase();" value="Cancel" />
