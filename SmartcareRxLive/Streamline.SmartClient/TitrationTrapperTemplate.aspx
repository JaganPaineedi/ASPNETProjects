                            ...
                            <tr>
                                <td valign="top">
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td class="labelFont" align="left" style="width: 80px">Drug &nbsp;
                                            </td>
                                            <td style="width: 5px" align="left">&nbsp;</td>
                                            <td align="left">
                                                <asp:Label ID="LabelDrugName" runat="server" CssClass="Label"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            ...
                                            <asp:RadioButton ID="RadioButtonPrescriberTemplate" runat="server" Text="Other Prescriber's Template"
                                                GroupName="Type" CssClass="SumarryLabel" AutoPostBack="false" />--%>
                                                <input id="RadioButtonClinicianTemplate" runat="server" style="color: black; font-family: Microsoft Sans Serif; font-size: 8.25pt; font-weight: normal; text-align: center"
                                                    checked="true" type="radio" name="TemplateType" onclick="GetTitrationTemplate('Client');" tabindex="1" /><a
                                                        style="color: black; font-family: Microsoft Sans Serif; font-size: 8.25pt; font-weight: normal; text-align: center">My Template</a>
                                                <input id="RadioButtonPrescriberTemplate" runat="server" name="TemplateType" style="color: black; font-family: Microsoft Sans Serif; font-size: 8.25pt; font-weight: normal; text-align: center"
                                                    type="radio" onclick="GetTitrationTemplate('Others');" tabindex="3" /><a style="color: black; font-family: Microsoft Sans Serif; font-size: 8.25pt; font-weight: normal; text-align: center">Other
                                                        Prescriber's Template</a>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            ...
                                            <td align="left" style="width: 25%">
                                                ...
                                                <img id="ImgStartDate" src="App_Themes/Includes/Images/calender_White.jpg" onclick="ClientMedicationTitration.CalShow(this, '<%=TextBoxTitrationTaperDate.ClientID %>')"
                                            ...
                                            <td align="center" width="20%">&nbsp;
                                                <input type="button" tabindex="4" id="buttonSelect" class="ButtonWeb" value="Select" onclick="ReturnValues();" />
                                            </td>
                                            <td align="left" style="width: 5%">&nbsp;
                                            </td>
                                            <td align="left">
                                                <input type="button" tabindex="5" id="buttonCancel" class="ButtonWeb" value="Cancel" onclick="CloseTemplate()" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
