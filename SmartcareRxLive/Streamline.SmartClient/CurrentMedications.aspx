    ...
    <table border="0" cellpadding="0" cellspacing="0" width="96%">
        <tr>
            <td style="width: 49%;" align="right">
                <input id="ButtonSelect" type="button" runat="server" value="Select" class="ButtonWeb"
            ...
            <td style="width: 49%;" align="left">
                <input id="ButtonCancel" type="button" value="Cancel" class="ButtonWeb" onclick="javascript:CloseCurrentMedication();" />
