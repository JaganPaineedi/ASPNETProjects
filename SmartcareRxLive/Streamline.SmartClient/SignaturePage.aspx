                ...
                <td style="height: 260px; width: 580px;">
                    <table style="width: 580px">
                        ...
                        <tr>
                            ...
                            <table style="border-bottom: #dee7ef 3px solid; border-left: #dee7ef 3px solid; border-right: #dee7ef 3px solid; border-top: #dee7ef 3px solid; width: 565px;">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td nowrap="nowrap" style="width: 220px">
                                <input type="button" id="ButtonSign" value="Sign" class="ButtonWeb" style="width: 60px"
                                    runat="server" />
                                <input type="button" value="Clear" class="ButtonWeb" onclick="ClearControls();" style="width: 53px" />
                                <input type="button" value="Cancel" class="ButtonWeb" onclick="closeWindow();" />
                            </td>
