                ...
                <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                        ...
                        <td>
                                ...
                                <tr>
                                    <td valign="top">
                                            ...
                                            <asp:GridView runat="server" Width="95%" AutoGenerateColumns="false" ID="GridViewSystemActions"
                    ...
                    <tr>
                        <td style="height: 25px">
                            <input id="ButtonOk" runat="server" type="button" value="OK" onclick="SetParentReturnValue('ok');" />
