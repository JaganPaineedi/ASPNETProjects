<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
			...
			<tr>
				<td>
					<table border="0" cellpadding="2" cellspacing="0">
						<tr>
							<td style="color: black" bgcolor="#dce5ea">Transaction Set</td>
							<td colspan="5">
	...
	<xsl:template match="erroridentification">
		<tr>
			<td style="color: black" bgcolor="#dce5ea">Segment</td>
			<td>
				<xsl:value-of select="segmentidcode" />
			</td>
			<td style="color: black" bgcolor="#dce5ea">Position</td>
			<td>
				<xsl:value-of select="segmentposition" />
			</td>
			<td style="color: black" bgcolor="#dce5ea">Loop</td>
			<td>
		...
		<xsl:if test="segmentidcode='N4'">
			<tr style="background-color:#e5e5e5;">
				<td style="color: black" bgcolor="#dce5ea">Segment Info</td>
	...
	<xsl:template match="errorelement">
		<tr>
			<td style="color: black" bgcolor="#dce5ea">
	...
	<xsl:template match="transactionsetreponsetrailer">
		<tr>
			<td colspan="2" style="color: black" bgcolor="#dce5ea">
	...
	<xsl:template match="infosource">
		<tr class="EligibilityView">
			...
			<tr>
				<td style="color: black" bgcolor="#dce5ea" colspan="5">
	...
	<xsl:template match="inforeceiver">
		<tr>
			<td style="color: black" bgcolor="#dce5ea" colspan="8">
				<b>Provider</b>
			</td>
		</tr>
		<tr class="EligibilityView">
