...
var MedicationPrescribe = {
    ...
    dialogForClose: function () {
        var answer = window.showModalDialog('YesNo.aspx?CalledFrom=Prescribe', 'YesNo', 'menubar : no;status : no;dialogHeight:150px;dialogWidth=340px;resizable:no;dialogTop:200px;dialogLeft:300px,location:no; help: No;');
        if (answer == 'Y') {
    ...
    openPharmacySearchForprint: function (DropDownPharmacies) {
        try {
            ...
            iFrameSearch.style.height = '560px';
