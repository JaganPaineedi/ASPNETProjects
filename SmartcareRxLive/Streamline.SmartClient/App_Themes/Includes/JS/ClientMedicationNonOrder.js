...
var ClientMedicationNonOrder = {
    ...
    dialogForClose: function () {
        var answer = window.showModalDialog('YesNo.aspx?CalledFrom=Nonorder', 'YesNo', 'menubar : no;status : no;dialogHeight:150px;dialogWidth=320px;resizable:no;dialogTop:200px;dialogLeft:300px,location:no; help: No;');
        if (answer == 'Y') {
