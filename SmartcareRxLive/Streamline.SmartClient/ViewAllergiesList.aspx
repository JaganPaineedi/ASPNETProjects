                        ...
                        <tr>
                            <td valign="top">
                                ...
                                <table border="0px" cellpadding="0" cellspacing="0" align="center">
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <table cellpadding="0" cellspacing="0" style="border: 1px; border-color: Black; height: 100px;"
                                                id="TableAllergies">
                                                <tr>
                                                    <td style="border: 1px; border-color: Black; border-style: solid; width: 340px;">
                                                            ...
                                                            <asp:GridView ID="DataGridAllergies" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField ControlStyle-Width="5%">
                                                                        <ItemTemplate>
                                                                            <asp:RadioButton ID="RadioSelect" name="RadioSelect" GroupName="Radio" AutoPostBack="false"
                                                                                runat="server" />
                                                                        </ItemTemplate>
                                                                        <ItemStyle Width="2%" />
                                                                    </asp:TemplateField>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <table class="ArjunTesting" border="1" cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <asp:TextBox ID="TextBoxComments" EnableTheming="false" runat="server" TextMode="MultiLine"
                                                MaxLength="1000" Width="98%" TabIndex="2"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td style="height: 10px" align="center" colspan="2">
                                            <asp:Button ID="btnSelect" runat="server" EnableViewState="False" OnClientClick="return AllergySearch.fnReturnValues();"
                                                Text="Select" Width="82px" CssClass="ButtonWeb" TabIndex="5" />
                                            &nbsp;
                                        <asp:Button ID="btn1" runat="server" OnClientClick="AllergySearch.closeDiv(0,-1);" CssClass="ButtonWeb"
