                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    ...
                                                    <td align="right" nowrap="nowrap">
                                                        <input type="Button" id="ButtonSave" value="Save/Close" class=" ButtonWebBold" onclick="SaveAgencyKeyPhrases();" />
                                                        <input type="Button" id="ButtonCancel" value="Cancel" class=" ButtonWebBold" onclick="CloseAgencyKeyPhrases();" />
