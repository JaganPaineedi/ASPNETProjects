...
<body onload=" Javascript:ClientMedicationTitration.GetTitrationValues(); "
    ...
    <form id="form1" runat="server">
        ...
        <div style="height: 680px;">
            <table border="0" cellpadding="0" cellspacing="5" style="height: 680px">
                <tr>
                    <td>
                        <asp:Label ID="LabelClientInfoTitle" runat="server" Visible="true" CssClass="TittleBarBase"
                            Text="Titration / Taper – Client: Smith, John (12345), DOB: 9/1/1965"></asp:Label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td valign="top">
                        <table style="border-bottom: #FFFFFF 3px solid; border-left: #FFFFFF 3px solid; border-right: #FFFFFF 3px solid; border-top: #FFFFFF 3px solid; width: 100%;" cellspacing="0" cellpadding="0">
                            <tr>
                                <td rowspan="1" style="width: 105px;" class="labelFont">Drug
                                </td>
                                <td style="width: 4px">&nbsp;
                                </td>
                                ...
                                <td colspan="3" style="width: 150px;" class="labelFont">Note
                                </td>
                            ...
                            <tr>
                                <td style="width: 105px;" class="labelFont">Type
                                </td>
                                <td style="width: 4px"></td>
                                <td style="width: 112px;">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                            <tr style="height: 10px;">
                                <td>
                                    <input type="button" id="ButtonUseTemplate" class="ButtonWeb" value="Use Template"
                                        onclick=" OpenTitrationTemplate(); " />
                                    &nbsp;&nbsp;&nbsp;
                                        <input type="button" id="ButtonSaveAsTemplate" runat="server" class="ButtonWeb" value="Save As Template" />
                                    &nbsp;&nbsp;&nbsp;
                                        <input type="button" id="ButtonClearSteps" class="ButtonWeb" value="Clear Steps and Start Over"
                                    ...
                                    <table border="0" width="100%">
                                        <tr>
                                            ...
                                            <td style="height: 19px; width: 120px;" nowrap>
                                                ...
                                                <img id="ImgOrderDate" src="App_Themes/Includes/Images/calender_White.jpg" onclick="ClientMedicationTitration.CalShow(this, '<%=TextBoxStartDate.ClientID%>')"
                                            ...
                                            <td style="height: 19px" nowrap>
                                                ...
                                                <img id="Img1" src="App_Themes/Includes/Images/calender_White.jpg" onclick="ClientMedicationTitration.CalShow(this, '<%=TextBoxEndDate.ClientID%>')"
                                                    ...
                                                    <table style="border-bottom: #FFFFFF 3px solid; border-left: #FFFFFF 3px solid; border-right: #FFFFFF 3px solid; border-top: #FFFFFF 3px solid; width: 100%;" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td rowspan="2" colspan="9" style="height: 40px; width: 650px;">
                                                                <div style="height: 40px; overflow: auto; scrollbar-base-color: Transparent; width: 640px;">
                        ...
                        <table width="100%">
                            <tr>
                                ...
                                <td align="right" valign="top" style="width: 50px;">
                                    <input type="button" id="ButtonSave" class="ButtonWeb" onclick=" ClientMedicationTitration.UpdateTitration() "
                                        value="Save & Close" />
                                </td>
                                <td align="right" valign="top" style="width: 50px;">
                                    <input type="button" id="ButtonCancel" class="ButtonWeb" onclick=" ClientMedicationTitration.redirectToOrderPageClearSession() "
                            ...
                            <tr>
                                <td align="center" class="footertextbold" colspan="3">
                                    <b>
